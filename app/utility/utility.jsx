...
//! @param 		calcVar 	[immutable.Map] The calculator variable to calculate the raw value of.
...
//! @brief		Finds the array index of the given unit label in the given unit array.
//! @param 		unitArray 	[immutable.List] The array of calculator units to search through.
//! @param 		label       [string] The label to look for in unitArray.
//! @returns 	The array index which has the same unit label.
export function findUnitIndexByLabel(unitArray, label) {
	console.log('findUnitIndexByLabel() called with unitArrary.toJS() =');
	console.log(unitArray.toJS());
